  ...
  <div class="wrapper">
    ...
    <side-bar logo="img/brand/global_tech.png">
      <template slot="links">
        ...
        <sidebar-item :link="{ name: 'Forms', icon: 'ni ni-single-copy-04 text-pink' }">
        ...
        <sidebar-item :link="{ name: 'Tables', icon: 'ni ni-align-left-2 text-default' }">
        ...
        <sidebar-item :link="{ name: 'Maps', icon: 'ni ni-map-big text-primary' }">
          <sidebar-item :link="{ name: 'Google', path: '/maps/google' }"/>
          <sidebar-item :link="{ name: 'Vector', path: '/maps/vector' }"/>
        </sidebar-item>
        <sidebar-item :link="{ name: 'Widgets', icon: 'ni ni-archive-2 text-green', path: '/widgets' }"> </sidebar-item>
        <sidebar-item :link="{ name: 'Charts', icon: 'ni ni-chart-pie-35 text-info', path: '/charts' }"> </sidebar-item>

        <sidebar-item :link="{ name: 'Calendar', icon: 'ni ni-calendar-grid-58 text-red', path: '/calendar' }"> </sidebar-item> -->
      </template>
